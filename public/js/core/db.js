// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// cel mai important script din site.
// controlează tot ce ține cont de date, salvări, etc.
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
// ~~~~~~~~~ formulă pentru EXP (când utilizatorul dă level up, EXP-ul necesar pentru încă un level crește) ~~~~~~~~~~
export function getXPNeeded(level) {
  return Math.floor(100 * Math.pow(1.25, level - 1));
}

// ~~~~~~~~~ date de bază pe care utilizatorul le primește la creearea contului ~~~~~~~~~~
...
//~~~~~~~~~ inițializăm utilizatorul când intră pe site ~~~~~~~~~~
...
//~~~~~~~~~ încărcăm salvarea utilizatorului ~~~~~~~~~~
...
// ~~~~~~~~~ pentru când utilizatorul completează un nivel ~~~~~~~~~~
...
// ~~~~~~~~~ pentru când utilizatorul cumpără ceva din shop ~~~~~~~~~~
